...
fpath = "test2.jpg"  # TODO: replace with your path
...
for color, count in zip(colors, counts):
    ...
    SINGLE_COLOR = (255 * np.ones(IMG.shape)).astype(
        np.uint8
    )  # Make sure casted to uint8
    ...
    cv.imwrite("unique_color/color={}_count={}.png".format(color, count), SINGLE_COLOR)
